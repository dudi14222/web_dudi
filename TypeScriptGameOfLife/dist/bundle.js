...
var GameView = function () {
    ...
    _createClass(GameView, [{
        ...
        value: function setCellStatus(i, j, status) {
            var tableCell = this.table.rows[i].cells[j];
            if (status) {
                (0, _jquery2.default)(tableCell).addClass("selected");
            } else {
                (0, _jquery2.default)(tableCell).removeClass("selected");
            }
        }
    }, {
        key: "initCells",
        value: function initCells(arr) {
            for (var i = 0; i < this.table.rows.length; i++) {
                for (var j = 0; j < this.table.rows[i].cells.length; j++) {
                    var c1 = this.table.rows[i].cells[j];
        ...
        value: function initTableClickEvent(bindEvent) {
            if (this.table != null) {
                for (var i = 0; i < this.table.rows.length; i++) {
                    for (var j = 0; j < this.table.rows[i].cells.length; j++) {
                        if (bindEvent) {
                            (0, _jquery2.default)(this.table.rows[i].cells[j]).bind("click", clickHandler);
                        } else {
                            (0, _jquery2.default)(this.table.rows[i].cells[j]).unbind("click", clickHandler);
                        }
                    }
                }
            }
        ...
        value: function buildTable() {
            ...
            (0, _jquery2.default)(this.table).append(cells);
        }
    }]);
...
var _GameModel = __webpack_require__(2);
...
function init() {
    (0, _jquery2.default)('#box-build').hide();
    ...
    (0, _jquery2.default)('#box-start').show();
}
function startTheGame() {
    (0, _jquery2.default)('#box-start').hide();
    gameController.initCells();
    gameController.removeTableClickEvent();
    gameController.start();
}
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('#btn-build-table').click(function () {
        return init();
    });
    (0, _jquery2.default)('#btn-start').click(function () {
        return startTheGame();
    });
});
